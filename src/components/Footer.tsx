    ...
    return (
        <footer className="bg-stone-50 border-t border-stone-200 pt-16 pb-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-2xl font-semibold tracking-tight text-stone-900">Église Nkom Kana</span>
                        </div>
                    ...
                    <div>
                        <h3 className="text-stone-900 font-semibold mb-4">Contact</h3>
                    ...
                    <div>
                        <h3 className="text-stone-900 font-semibold mb-4">Suivez-nous</h3>
                ...
                <div className="mt-16 pt-8 border-t border-stone-200 text-center text-stone-500 text-sm">
