    ...
    return (
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="space-y-12">
                {days.map((day) => {
                    const items = getProgramByDay(day.value);
                    return (
                        <div key={day.value} className="relative pl-8 md:pl-0">
                            <div className="md:grid md:grid-cols-4 gap-8">
                                <div className="mb-6 md:mb-0">
                                    <div className="bg-stone-900 text-white p-6 rounded-2xl md:text-center sticky top-24 inline-block md:block min-w-[140px]">
                                        <span className="block text-amber-500 font-bold uppercase tracking-widest text-[10px] mb-1">{t('day_label')}</span>
                                        <span className="text-2xl font-bold tracking-tight">{day.label}</span>
                                    </div>
                                </div>
